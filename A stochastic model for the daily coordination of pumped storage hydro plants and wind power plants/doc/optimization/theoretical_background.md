...
* **$x_{i \to utility, t}^{P}$ (Water Export):** Unlike traditional models, this flow is enabled to represent the "Regulation Down" logic, where surplus water is shared/sold back to the network rather than discharged2222.
